...
El grabado de comentarios en una característica fundamental del programa. Tenerla permite que se empiece a implementar
la gamification, pues a medida que avance el desarrollo los comentarios grabados se pueden reproducir o compartir con
otros usuarios de la aplicación. Las categorías de grabado son: Anuncio de pausas cortas, anuncio de
pausas largas, anuncio de descansos, anuncio de fines de descanso y sonidos personalizados para otros usuarios
(recompensas).
