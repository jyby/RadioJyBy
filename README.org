...
** Videos
   - Extend it so that to play videos in addition to music and recordings
   - applications
     - play some music videos or relaxing videos during the breaks;
     - plays some video messages from friends and family instead of just an audio recording.
